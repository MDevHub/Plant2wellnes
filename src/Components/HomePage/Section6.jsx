...
const faqs = [
  ...
  {
    question: "What if I don't have access to recommended herbs for the challenge?",
    answer:
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-between p-5 text-left text-green-800 font-medium text-lg hover:bg-green-100 transition-colors duration-300"
              >
