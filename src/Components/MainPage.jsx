      ...
      <>
         ...
         <aside className="relative hidden lg:block lg:col-span-1">
            ...
            <div style={{ height: isFixed && sidebarRef.current ? `${sidebarRef.current.offsetHeight}px` : 'auto' }}>
               ...
               style={{ width: isFixed ? '300px' : 'auto' }}
               >
               <h2 className="text-[#3e7752] text-xl font-semibold">
               ...
               {/* CTA */}
               <button className="relative overflow-hidden bg-[#3e7752] text-white px-6 py-2 rounded-full mt-2">
               ...
               {/* Highlight */}
               <div className="bg-[#4f8a63] text-white text-center text-sm py-2 px-4 rounded-md mt-4">
